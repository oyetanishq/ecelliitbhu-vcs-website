    ...
    <main className="min-h-screen bg-cover bg-center bg-fixed text-white" style={{ backgroundImage: "url('/e-cell.jpeg')" }}>
      ...
      <div className="relative max-w-6xl mx-auto p-6 space-y-16 pt-28">
        ...
        <section className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            <h1 className="text-5xl md:text-6xl font-extrabold mb-6 text-[#FF8C00] leading-tight">
            ...
            <div className="flex gap-4 flex-wrap">
              <Link
                href="/auth"
                className="px-6 py-3 bg-[#FF8C00] text-black font-semibold rounded-full hover:bg-[#FFA500] active:scale-95 transition-all shadow-sm"
              >
                Join Now
              </Link>
              <Link
        ...
        {/* Popular Courses */}
        <section>
          <h2 className="text-3xl font-bold mb-8 text-[#FF8C00] border-b border-[#FF8C00] pb-2 text-center md:text-left">
            Popular Courses
          </h2>
        ...
        {/* Footer */}
        <footer className="text-center text-sm text-gray-500 py-10 border-t border-zinc-800 relative">
