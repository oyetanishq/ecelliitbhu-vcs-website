  ...
  const courseWeeks = [
    {
      ...
      description: "This week covers Python basics along with essential libraries like Pandas, Numpy, and Matplotlib, and introduces core concepts of Exploratory Data Analysis (EDA) and Feature Engineering.",
    ...
    },
    {
      ...
      description: "This week covers various important ML algorithms like SVM, KMeans, KNN and also familiarises you with unsupervised learning, PCA(Principal Component Analysis). It also introduces dimensionality reduction, clustering methods, and anomaly detection.",
      topics: ["SVM", "KMeans", "KNN", "PCA", "Clustering", "Anomaly Detection"]
    },
    {
      week: 4,
      title: "Ensemble Learning & Kaggle",
      description: "This week introduces ensemble learning methods like Random Forest, Gradient Boosting, and XGBoost. You'll also learn about semi-supervised learning and get hands-on experience with Kaggle competitions.",
      topics: ["Random Forest", "Gradient Boosting", "XGBoost", "Semi-Supervised Learning", "Kaggle"]
    },
    {
      week: 5,
      title: "Deep Learning Fundamentals",
      description: "This week dives into neural networks, deep learning frameworks, and introduces you to TensorFlow and PyTorch. You'll learn about CNNs, RNNs, and basic neural network architectures.",
  ...
  return (
    <div className="min-h-screen hero-background">
      {/* Hero Section */}
        ...
        {/* You can add an overlay for better text readability over the background */}
        ...
        <div className="relative w-full max-w-3xl h-[60vh] md:h-[70vh]">
          ...
          {weeks.map((item) => (
            <div
              key={item.id}
              className="absolute bg-black/40 backdrop-blur-md border border-white/10 rounded-2xl p-6 w-64 transition-all duration-300 hover:border-cyan-400/50 hover:shadow-2xl hover:shadow-cyan-400/10"
          ...
          {/* Hackathon Card */}
          <div 
            className="absolute bg-black/40 backdrop-blur-md border-2 border-cyan-400 rounded-2xl p-6 w-64 text-center transition-all duration-300 shadow-2xl shadow-cyan-400/20"
        ...
        <div className="relative z-10 max-w-3xl ml-auto mr-4 md:mr-20 text-right">
          <div className="space-y-6">
            <div className="text-sm text-primary font-medium tracking-wider">
            ...
            <h1 className="text-5xl md:text-7xl font-bold leading-tight">
              The perfect start
              <br />
              <span className="text-gradient">for your AI journey.</span>
            </h1>
            
            <p className="text-lg text-muted-foreground max-w-2xl ml-auto">
              The summer course on Data Science and Machine Learning offers a comprehensive blend of high-quality resources sourced from the internet, including engaging videos, informative blogs, weekly assignments, and culminating in an exciting hackathon to assess your knowledge and skills.
            </p>
        ...
        <div className="lg:hidden absolute bottom-10 left-0 right-0 flex justify-center gap-2 px-4 overflow-x-auto pb-4">
          {weeks.map((item) => (
            <div key={item.week} className="bg-card border border-border rounded-lg p-3 min-w-[120px] flex-shrink-0">
              <div className="text-primary text-sm font-bold">Week {item.week}</div>
      ...
      <section id="course-structure" className="py-20 px-4 md:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <div className="text-sm text-primary font-medium tracking-wider mb-4">
            Course Outline
          </div>
          ...
          <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
            The 6 week course takes you from basic Python to complex neural networks. The course is structured as follows:
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {courseWeeks.map((week, index) => (
            <Card 
              key={week.week}
              className="p-6 bg-card/50 backdrop-blur-sm border-border hover:border-primary transition-all duration-300 hover:shadow-[0_0_30px_hsl(188_85%_43%/0.2)] group"
              style={{ animationDelay: `${index * 100}ms` }}
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center border border-primary/20 group-hover:border-primary transition-colors">
                  <span className="text-primary font-bold text-lg">{week.week}</span>
                </div>
          ...
          {/* Hackathon Card */}
          <Card className="p-6 bg-gradient-to-br from-primary/10 to-primary/5 backdrop-blur-sm border-primary hover:shadow-[0_0_40px_hsl(188_85%_43%/0.4)] transition-all duration-300 group md:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
            ...
            <p className="text-sm text-muted-foreground mb-4 leading-relaxed">
              Put all your learning to test in an exciting hackathon! Work on real-world projects, compete with peers, and showcase your skills. This is your chance to apply everything you've learned throughout the course.
            </p>
      ...
      <section className="py-20 px-4 md:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-lg">
            Explore the daily breakdown of each week's content
          </p>
        </div>
                    ...
                    <TableBody>
                      {weeklyData[week as keyof typeof weeklyData].map((day, index) => (
                        <TableRow key={index} className="hover:bg-primary/5 transition-colors">
                          <TableCell className="font-semibold text-primary">{day.day}</TableCell>
                      ...
                      <TableRow className="bg-primary/10 hover:bg-primary/15">
                        <TableCell colSpan={5} className="text-center font-bold text-primary py-4">
              ...
              <div className="rounded-lg border border-border p-8 bg-card/50 backdrop-blur-sm text-center">
                ...
                <div className="grid md:grid-cols-2 gap-4 max-w-2xl mx-auto text-left">
                  <div className="p-4 border border-border rounded-lg hover:border-primary transition-colors">
                    <div className="font-semibold text-primary mb-2">Data Visualization</div>
                    <div className="text-sm text-muted-foreground">Seaborn & Plotly tutorials</div>
                  </div>
                  <div className="p-4 border border-border rounded-lg hover:border-primary transition-colors">
                    <div className="font-semibold text-primary mb-2">Linear Algebra</div>
                    <div className="text-sm text-muted-foreground">Mathematical foundations</div>
                  </div>
                  <div className="p-4 border border-border rounded-lg hover:border-primary transition-colors">
                    <div className="font-semibold text-primary mb-2">Practice Exercises</div>
                    <div className="text-sm text-muted-foreground">Additional challenges</div>
                  </div>
                  <div className="p-4 border border-border rounded-lg hover:border-primary transition-colors">
                    <div className="font-semibold text-primary mb-2">Python OOPs</div>
        ...
        <div className="md:hidden text-center p-8 border border-border rounded-lg bg-card/50 backdrop-blur-sm">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            Please view on a larger screen to see the detailed curriculum table.
          </p>
        </div>
      </section>
    </div>
