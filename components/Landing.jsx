...
export default function Landing({ COURSES }) {
  ...
  return (
    <main className="max-w-6xl mx-auto p-6 space-y-16 bg-transparent text-white min-h-screen">
        ...
        <div>
          ...
          <div className="flex gap-4">
            <button
              ...
              className="px-6 py-2.5 bg-orange-500 text-black font-semibold rounded-full hover:bg-orange-400 transition-colors"
            >
              Join Now
            </button>
            ...
            <button
              ...
              className="px-6 py-2.5 border border-orange-500 text-orange-500 font-semibold rounded-full hover:bg-orange-500 hover:text-black transition-colors"
            >
              Explore Courses
            </button>
          </div>
      ...
      <section>
        <h2 className="text-2xl font-bold mb-8 text-orange-500 border-b-2 border-orange-600 pb-2">
          Popular Courses
        </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {COURSES.map((c) => (
            <article
              key={c.id}
              className="p-6 border border-orange-600 rounded-2xl bg-zinc-900 hover:shadow-lg hover:shadow-orange-500/20 transition"
            >
      ...
      {/* FOOTER */}
      <footer className="text-center text-sm text-gray-500 py-10 border-t border-orange-600">
        © {new Date().getFullYear()} E-Cell IIT BHU
      </footer>
    </main>
  );
}
